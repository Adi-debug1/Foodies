      ...
      <div className="card-body">
        ...
        <form onSubmit={onSubmitHandler}>
          ...
          <div className="mb-3">
            ...
            <textarea className="form-control" placeholder='Write conent here' id="description" rows="5" required name='description' onChange={onChangeHandler} value={data.description}></textarea>
          </div>
