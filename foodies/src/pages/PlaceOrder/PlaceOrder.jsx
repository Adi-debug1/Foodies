...
import { RAZORPAY_KEY } from '../../util/contanst';
...
const PlaceOrder = () => {
    ...
    const verifyPayment = async (razorpayResponse) => {
        ...
        try {
            ...
            toast.error("Payment failed. Pleaser truy again");
        }
    }
                        ...
                        <form className="needs-validation" onSubmit={onSubmitHandler}>
                            <div className="row g-3">
                                ...
                                <div className="col-12">
                                    ...
                                    id="phone" placeholder="9876543210" 
                                    name='phoneNumber'
                                    onChange={onChangeHandler}
                                ...
                                <div className="col-md-3">
                                    ...
                                    <input type="number" className="form-control" id="462020" required name='zip' onChange={onChangeHandler} value={data.zip}/>
                                </div>
                            </div>
